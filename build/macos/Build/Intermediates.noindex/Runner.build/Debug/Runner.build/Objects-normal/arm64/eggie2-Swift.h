...
#ifndef EGGIE2_SWIFT_H
#define EGGIE2_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="eggie2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC6eggie211AppDelegate")
...
SWIFT_CLASS("_TtC6eggie217MainFlutterWindow")
